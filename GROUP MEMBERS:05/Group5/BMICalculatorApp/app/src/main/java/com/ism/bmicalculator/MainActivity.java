...
public class MainActivity extends AppCompatActivity {
        ...
        calculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(weight.isEmpty() || height.isEmpty())
                {
                    ...
                    //call the function for dialog box
                    alert("Please Insert Weight and Height");
                }
                else
                {
    ...
    //create the function for dialog box
    ...
    private void sendRequestToCalculateBMI(String height, String weight){
        ...
        String url = "http://192.168.43.144/bmi_api/store_bmi_data.php?height="+height+"&weight="+weight;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        alert("No any response from API call, Please try again later");
                    }
                });
